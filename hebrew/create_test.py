...
phonemes = [
    ...
    # "ɛŋrɬ rɲʍrɢɭɬ fɲɟɭɬ ŋʕrɛɭɬ fɭɔɪrʍɭf. ŋʰf ɢŋ ɢħ ɣɛf ŋɦcrʍ ɟc ɲʕɭɭc ffcʄʰʰrc fˤŋrɲŋɭc?"
    ...
    phonemizer.phonemize('Success is not final, failure is not fatal: it is the courage to continue that counts.'),
